...
SWIGINTERN PyObject *_wrap_init_test(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  int result;
  
  if (!PyArg_ParseTuple(args,(char *)":init_test")) SWIG_fail;
  result = (int)init_test();
  resultobj = SWIG_From_int(static_cast< int >(result));
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_get_dorsal_muscle_activation(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  arg1 = static_cast< int >(val1);
  result = (float)get_dorsal_muscle_activation(arg1);
  resultobj = SWIG_From_float(static_cast< float >(result));
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_get_ventral_muscle_activation(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  arg1 = static_cast< int >(val1);
  result = (float)get_ventral_muscle_activation(arg1);
  resultobj = SWIG_From_float(static_cast< float >(result));
  return resultobj;
fail:
  return NULL;
